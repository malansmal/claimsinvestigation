	...
	if(isset($submit) && $human == 10 && empty($bot)) {
		...
		if ($resultmail->num_rows > 0) {
			...
			while($rowmail = $resultmail->fetch_assoc()) { 
				...
				$to			= $rowmail['email'];
				$subject	= "Ref: $ref Please quote on the following parts needed";
			...
			if ($emailSent > 0) {
				...
				<p>Thank you for sending a request for parts wanted. Please note that 
				<a href="http://partfinders.co.za" title="Partfinders.co.za">Partfinders</a> does no supply parts.
				<br><br>
				<a href="http://partfinders.co.za" title="Partfinders.co.za">Partfinders</a>
				will forward your Parts Request to all our listed parts suppliers in your area for the make of vehicle you want parts for.
				<br><br>
				If you do not receive a reply within 24 hours, assume parts are not available and make other arrangments as parts suppliers 
				are requested only to reply if parts are available with prices and will sell direct to you. 
				<a href="http://partfinders.co.za" title="Partfinders.co.za">Partfinders</a>
				are not responsible for any transaction and or guarantee parts. 
				<br><br>
				For Insurance Parts Wanted, please confirm buying new parts with assessor, if no reply is received within 24 hours of your 
				request for parts.<br><br>
				</p>
				<p><a href="http://partfinders.co.za" title="Partfinders.co.za">Partfinders</a></p>
				';
			...
			if ( empty($errorMessage) ) {
				...
				If you do not receive a reply from any parts supplier within 24 hours, assume parts are not available and make other
				arrangments. Insurance Parts Wanted - please confirm buying NEW or Alternate parts with Assessor';			
			}
...
<div class="container" id="main-box">
 ...
 <div class="row">
 <div class="col-md-12">
 <a href="http://partfinders.co.za"><img src="images/Partfinders.png" class="img-responsive" alt="Partfinders"></a> <br />
 </div>
  <div class="col-md-12">
  <div class="alert alert-info">
  <p>If you are looking for parts you can not find on the website, Please complete the form below with the parts you need and we 
  will forward your request to our all parts suppliers in your area for the make of vehicle. Part Suppliers will reply direct to you, via 
  phone or email with prices ONLY when parts are available. If no reply is received within 24 Hours, please assume parts are not available and make
  other arrangments. For Insurance Claims please contact assessor to obtain new or alternate parts.</p>
  </div><!-- /alert-info -->
  </div>
  </div><!-- /row -->
  </div><!-- /well -->
