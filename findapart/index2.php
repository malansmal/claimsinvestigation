<?php
	...
	if(isset($submit) && $human == 10 && empty($bot)) {
		...
		$headers .= 'Bcc: info@partfinders.co.za' . "\r\n";
...
<option value="<?php echo $rowarea['areaname']; ?>"><?php echo $rowarea['areaname']; ?></option>
<?php } ?>
</select>
</div>
<div class="form-group">
