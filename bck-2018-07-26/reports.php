    ...
    if ($action == "pbfax")
    {
        ...
        $theemail = "<table style=\"width:600px;\" border=\"0\">
									...
									<tr>
										...
										<td style=\"width:172px;\"><img src=\"../images/acilogo.gif\"></td>
										...
										<td align=\"left\">
											...
											<font style=\"font-size:10pt;font-family:Arial;color:blue;\">aci@aci.co.za</font>											
								...
								<table style=\"width:600px;\" border=\"0\">
									...
									<tr>
										...
										<td colspan=\"4\" style=\"text-align:justify;\"><font style=\"font-size:10pt;font-family:Arial;\">The following adjustment will be made to the above claim for parts/labour/paint supplied and/or less paid for parts quoted. Please note that this adjustment amount will be deducted from Original Authorized amount and extra's will be added, where necessary. If you do not agree with this amount please do not hesitate to contact us. PLEASE note that any other payments must still be calculated by the Insurer where needed. <strong>Please note that a maximum of 25% mark-up will be allowed on parts.</strong></font></td>										
        ...
        $theemail .= "		<tr>
            ...
            round(($onetwofivetotal * 0.14), 2) . "</td>
									...
									<tr>
										...
										<td align=\"right\" style=\"border-bottom:1px solid #000000;border-right:1px solid #000000;\">" .
            round(($onetwofivetotal * 1.14), 2) . "</td>
            ...
            (($onetwofivetotal * 1.14), 2) - $betterment - $excess) . "</td>
									...
									<tr>
										...
										<td align=\"right\" style=\"border-bottom:1px solid #000000;border-right:1px solid #000000;\">" .
            round(($adjustmenttotal * 1.14), 2) . "</td>
									...
									<tr>
										...
										<td colspan=\"6\" style=\"border-right:1px solid #000000;border-left:1px solid #000000;border-bottom:1px solid #000000;border-top:1px solid #000000\">In order to expedite your claim, please sign the adjustment and fax back to us, as soon as possible. Fax: 086 673-9392</td>
    ...
    ***************************************************************************/
    ...
    if ($action == "pbfaxemail")
    {
        ...
        if ($sendemail == "yes")
        {
            ...
            $subject = "Adjustment Fax; Claimno: $claimno; Client: $clientname";
...
//echo "Message sent to $to_name, $to_address:<br />";
            ...
            else
            {
	            ...
	            $qryinsertreport = "insert into `report` (`id`, `claimid`, `reportdate`, `description`, `userid`) values ('', $claimid, '$now', 'Panel Beaters Fax sent to $to_address', $loggedinuserid)";
        ...
        $theemail = "<table style=\"width:600px;\" border=\"0\">
            ...
            date("j M Y") . "</font></td>										
									...
									<tr>
										...
										Please note that in order to finalise the above claim we require a Final Costing and copies of invoices, of all parts purchased, to be faxed to the above number as soon as possible. No payment for the above claim will be made until we have received all such documentation.<br><br>



										All original documentation must be kept for future reference and all old parts replaced, must be kept until further notice. All Motorcycle spares must be kept for collection. (Salvage) Please notify us as soon as Motorcycle spares can be collected.<br><br>
									...
									<tr>
										...
										<td colspan=\"4\" ><font style=\"font-size:10pt;font-family:Arial;\">Malan J. Smal</font></td>
    ...
    if ($action == "auditreport")
    {
        ...
        echo "<table style=\"width:600px;\" border=\"0\">
									...
									<tr>
										...
										<td style=\"width:250px;\" align=\"center\"><img src=\"../images/acilogo.gif\"></td>
										...
										<td align=\"left\">
											...
											<font style=\"font-size:10pt;font-family:Arial;\">Tel:0861114339 Fax:086 673-9392</font>
            ...
            date("j M Y") . "</font></td>								
									...
									<tr>
										...
										<td colspan=\"4\" style=\"text-align:justify;\"><font style=\"font-size:10pt;font-family:Arial;\">The above vehicle/invoices was inspected. Upon inspection it was found that some parts was not replaced as quoted and/or also less was paid for parts quoted. The adjustment is as follows;<br><br><br><br></font></td>										
        ...
        else
        {
            ...
            $acisavings = round(($adjustmenttotal * 1.14), 2);

            $totalsavings = round(($adjustmenttotal * 1.14), 2);
            ...
            //$total = round(($authamount + ($adjustmenttotal * 1.14)), 2);
        ...
        echo "	<form method=\"post\" action=\"reports.php?action=auditreportprint&amp;claimid=$claimid\" name=\"theform\">
								...
								<table style=\"width:600px;font-family:Arial;font-size:10pt;\" border=\"0\" cellspacing=\"0\">
									...
									<tr>
										...
										<td><input type=\"text\" name=\"acisavings\" value=\"" . round(($adjustmenttotal * 1.14), 2) . "\" style=\"text-align:right;width:75px;\" readonly></td>
            ...
            ($adjustmenttotal * 1.14)), 2)) - $betterment - $excess) . "\" style=\"text-align:right;width:75px;\" readonly></td>
            ...
            -0.45) * 1.14), 2) . "\" style=\"text-align:right;width:75px;\" readonly></td>
            ...
            ($adjustmenttotal * 1.14)), 2)) - $betterment - $excess)) + (round((($adjustmenttotal *
            -0.45) * 1.14), 2))) . "\" style=\"text-align:right;width:75px;\" readonly></td>
...
<script type=\"text/javascript\">
...

	{
		...
		document.theform.total.value = bigtotal;
            ...
            round(($adjustmenttotal * -0.45 * 0.14), 2) . "\"></td>
            ...
            round(($adjustmenttotal * -0.45 * 1.14), 2) . "\"></td>
    ...
    ***************************************************************************/
    ...
    if ($action == "pbinvoice")
    {
        ...
        {
			echo "<img src=\"../images/acilogo.jpg\"><br />";
		}
        ...
        echo "<form method=\"post\" action=\"reports.php?action=pbinvoiceprint&amp;claimid=$claimid\" name=\"theform\">	<table style=\"width:600px;font-family:Arial;font-size:10pt;border-top:1px solid #000000;\" border=\"0\" cellspacing=\"0\">
									...
									<tr>
										...
										<td style=\"border-bottom:1px solid #000000;border-right:1px solid #000000;border-left:1px solid #000000;\" align=\"right\">550.00</td>
...
<script type=\"text/javascript\">
...

	{
		...
		total = 550 + (document.theform.amount1.value * 1) + 
    ...
    ***************************************************************************/
    ...
    if ($action == "pbinvoiceprint")
    {
        ...
        {
			$theemail .= "<img src=\"http://www.a-c-i.co.za/images/acilogo.jpg\"><br />";
		}
								...
								<table style=\"width:600px;font-family:Arial;font-size:10pt;\" border=\"0\" cellspacing=\"0\">
									...
									<tr>
										...
										<td colspan=\"4\">
											...
											<!--<p style=\"text-align:justify;\">1. Maximum of 25% Mark-up will be allowed on all parts replaced, except if confirmed in writing. 2. All EXTRAS must be confirmed in writing with the assessor and such parts must be kept for 10 working days.  3. Second Hand parts are preferred over Pirate parts when needed. 4.All MOTORCYCLE PARTS must be kept by repairer and must notify A.C.I. 0861114339 as soon as parts can be collected.</p>
    ...
    ***************************************************************************/
    ...
    if ($action == "assessmentinstructionprint")
    {
        ...
        $email_message->SetEncodedEmailHeader("Cc", "aci@aci.co.za", "Malan");
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
            ...
            $qryinsertreport = "insert into `report` (`id`, `claimid`, `reportdate`, `description`, `userid`) values ('', $claimid, '$now', 'Email sent to $to_address', $loggedinuserid)";
            $qryinsertreportresults = mysql_query($qryinsertreport, $db);
...
<script>
...

	{
		...
		totalincvat = Math.round((total * 1.14) * 100) / 100;
    ...
    if ($action == "assessmentreportprint")
    {
        ...
        $theemail = "
            ...
            "</strong></td>
								...
								<input type=\"submit\" value=\"Printer Friendly\"> <input type=\"reset\" value=\"Clear\"> <input type=\"hidden\" name=\"claimid\" value=\"$claimid\">
    ...
    ***************************************************************************/
    ...
    if ($action == "authorization")
    {
    	...
    	$administratoradr1 = stripslashes($administratorrow["administratoradr1"]);
    	$administratoradr2 = stripslashes($administratorrow["administratoradr2"]);
    	$administratoradr3 = stripslashes($administratorrow["administratoradr3"]);
    	$administratoradr4 = stripslashes($administratorrow["administratoradr4"]);
		...
		{
			echo "<img src=\"../images/administrators/$administratorid.jpg\">";
		}
		else
		{
			echo "<img src=\"../images/acilogo.gif\">";
		}
		...
		echo "</td>
								...
								<table style=\"width:600px;font-family:Arial;font-size:10pt;\" border=\"0\" cellspacing=\"0\">
									...
									<tr>
										...
										<td align=\"center\"><font style=\"font-size:14pt;font-weight:bold;\">AUTHORIZATION FOR REPAIRS</font><br>$administratorname, VAT number:  $administratorvatno</td>
								...
								<table style=\"width:600px;font-family:Arial;font-size:10pt;\" border=\"0\" cellspacing=\"0\">
									...
									<tr>
										...
										<td><strong>$datereceived</strong></td>
								...
								<table style=\"width:500px;margin-left:100px;font-family:Arial;font-size:10pt;\" border=\"0\" cellspacing=\"0\">
									...
									<tr>
										...
										<td style=\"width:100px;\">Agreed Cost:</td>
								...
								<p style=\"text-align:justify;\">The above <strong>authorization</strong> is subject to the following <strong>terms and conditions:</strong></p>
								...
								<form name=\"theform1\" action=\"reports.php?action=authorizationemail\" method=\"post\">
    ...
    ***************************************************************************/
    ...
    START OF AUTHORIZATIONEMAIL SECTION
    ...
    ***************************************************************************/
    ...
    if ($action == "authorizationemail")
    {
		...
		if (file_exists("../images/administrators/$administratorid.jpg"))
		{
			$theemail .= "<img src=\"../images/administrators/$administratorid.jpg\">";
		}
		else
		{
			$theemail .= "<img src=\"../images/acilogo.gif\">";
		}
		...
		$theemail .= "</td>
            ...
            $from_address = "$ccemail";

            $from_name = "$claimsclerk";
            ...
            $subject = "Authorization for Repairs; Claimno: $claimno; Client: $clientname";
...
////////////////////////////////////////////////////////////////////SMS\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\
            ...
            else
            {
	            ...
	            $qryinsertreport = "insert into `report` (`id`, `claimid`, `reportdate`, `description`, `userid`) values ('', $claimid, '$now', 'Authorization sent to $to_address', $loggedinuserid)";
	            $qryinsertreportresults = mysql_query($qryinsertreport, $db);
    ...
    END OF AUTHORIZATIONEMAIL SECTION
