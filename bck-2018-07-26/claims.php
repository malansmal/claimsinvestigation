...
function SearchClaims($claimno, $clientno, $clientname, $vehicleregistrationno, $from, $admin, $panelbeatername)
{
    ...
    else
    {
        ...
        echo "Search results for Client Number: <strong>$clientno</strong>, Client Name: <strong>$clientname</strong>, Claim Number: <strong>$claimno</strong> and  Vehicle Registration Number: <strong>$vehicleregistrationno</strong><br><br>
...
function EditClaim($id, $step)
{
    ...
    if ($step == 1) //Claim Details
    {
...

		{
			...
			document.hiddenform.estimator.value = document.theform.estimator.value;
        ...
        echo "
					...
					<form method=\"post\" action=\"loggedinaction.php?action=editclaim\" name=\"theform\">
						<p>Client Number: <strong>$clientnumber2</strong>; Client Name: <strong>$clientname</strong>; Claim Number: <strong>$claimnumber</strong>; Vehicle Registration Number: <strong>$vehicleregistrationno</strong>; Panel Beater: <strong>$panelbeater</strong></p>
					<table>
					...
					<tr>
						...
						<td>	
							...
							<table bgcolor=\"#E7E7FF\" style=\"border:1px solid #000000;\" width=\"100%\" class=\"blue-bg\">
								<tr>
									<td colspan=\"6\" class='pad-10'><h4 style=\"margin-top:0px;margin-bottom:0;display:inline-block;\">Client:</h4>
									
										<div style=\"display:inline-block;\">
											Client Number: <input type=\"text\" value=\"$clientno\" maxlength=\"50\" name=\"clientno\" />
										</div>
										...
										<div style=\"display:inline-block;\">
											...
											<a href=\"mailto:$clientemail?subject=$emailSubject\" alt=\"Send Email\" title=\"Send Email\" class=\"send-email\" type=\"Client\" claimId=\"$claimid\" ><img src=\"../images/email-send.png\" style=\"height:20px;vertical-align:middle;\" /></a>
							...
							<table bgcolor=\"#D3D3FF\" style=\"border:1px solid #000000;\" width=\"100%\" class=\"pad-table blue-bg\">
								...
								<tr>
									...
									<td colspan=\"6\" class='pad-10'><h4 style=\"margin-top:0px;margin-bottom:0;display:inline-block;\">Panel Beater:</h4>
										...
										<div style=\"display:inline-block;\">
											...
											$workshopmanager = $selectedpbrow["workshopmanager"];

											$estimator = $selectedpbrow["estimator"];
											$pbestimatoremail = $selectedpbrow["pbestimatoremail"];
											...
											if ($dothepb == 1)
											{
												...
												$workshopmanager = $_REQUEST["workshopmanager"];
								...
								<tr>
									<td colspan=\"6\" class='pad-10'>
										...
										<div style=\"display:inline-block;width:24%;\">
											...
											<a href=\"mailto:$pbemail?subject=$emailSubject\" alt=\"Send Email\" title=\"Send Email\" class=\"send-email\" type=\"Panel Beaters\" claimId=\"$claimid\" ><img src=\"../images/email-send.png\" style=\"height:20px;vertical-align:middle;\" /></a>
										</div>
									</td>
								</tr>
								...
								<tr>
									...
									<td><input type=\"text\" value=\"$pbowneremail\" maxlength=\"50\" name=\"pbowneremail\" class='textinput-lg' />
										<a href=\"mailto:$pbowneremail?subject=$emailSubject\" alt=\"Send Email\" title=\"Send Email\" class=\"send-email\" type=\"Panel Beaters\" claimId=\"$claimid\" ><img src=\"../images/email-send.png\" style=\"height:20px;vertical-align:middle;\" /></a>
									</td>
								...
								<tr>
									...
									<td><input type=\"text\" value=\"$pbcostingclerkemail\" maxlength=\"50\" name=\"pbcostingclerkemail\" class='textinput-lg' />
										<a href=\"mailto:$pbcostingclerkemail?subject=$emailSubject\" alt=\"Send Email\" title=\"Send Email\" class=\"send-email\" type=\"Panel Beaters\" claimId=\"$claimid\" ><img src=\"../images/email-send.png\" style=\"height:20px;vertical-align:middle;\" /></a>
									</td>
								...
								<tr>
									...
									<td><input type=\"text\" value=\"$workshopmanager\" maxlength=\"50\" name=\"workshopmanager\"  /></td>

									<td>Email Address: </td>
									<td><input type=\"text\" value=\"$pbworkshopmanageremail\" maxlength=\"50\" name=\"pbworkshopmanageremail\" class='textinput-lg' />
										<a href=\"mailto:$pbworkshopmanageremail?subject=$emailSubject\" alt=\"Send Email\" title=\"Send Email\" class=\"send-email\" type=\"Panel Beaters\" claimId=\"$claimid\" ><img src=\"../images/email-send.png\" style=\"height:20px;vertical-align:middle;\" /></a>
									</td>
								...
								<tr>
									<td>Estimator: </td>
									<td><input type=\"text\" value=\"$estimator\" maxlength=\"50\" name=\"estimator\"  /></td>
									<td>Email Address: </td>
									<td><input type=\"text\" value=\"$pbestimatoremail\" maxlength=\"50\" name=\"pbestimatoremail\" class='textinput-lg' />
										<a href=\"mailto:$pbestimatoremail?subject=$emailSubject\" alt=\"Send Email\" title=\"Send Email\" class=\"send-email\" type=\"Panel Beaters\" claimId=\"$claimid\" ><img src=\"../images/email-send.png\" style=\"height:20px;vertical-align:middle;\" /></a>
									</td>
									<td>Province: </td>
							...
							<table bgcolor=\"#BFBFFF\" style=\"border:1px solid #000000;\" width=\"100%\" class='blue-bg'>
								...
								<tr>
									<td colspan=\"5\" class='pad-10'><h4 style=\"margin-top:0px;margin-bottom:0;display:inline-block;\">Vehicle:</h4>
							...
							<table bgcolor=\"#ABABFF\" style=\"border:1px solid #000000;\" width=\"100%\" class='blue-bg'>
								...
								<tr>
									...
									<td colspan=\"6\" class='pad-10'><h4 style=\"margin-top:0px;margin-bottom:0;display:inline-block;\">Administrator:</h4>
							...
							<table bgcolor=\"#9797FF\" style=\"border:1px solid #000000;\" width=\"100%\" class='blue-bg'>
								<tr>
									<td colspan=\"5\" class='pad-10'><h4 style=\"margin-top:0px;margin-bottom:0;display:inline-block;\">Claim:</h4>										
										<div style=\"display:inline-block;\">
							...
							<table bgcolor=\"#8383FF\" style=\"border:1px solid #000000;\" width=\"100%\" class=\"pad-table blue-bg\">
								...
								<tr>
									...
									<td colspan=\"5\" class='pad-10'><h4 style=\"margin-top:0px;display:inline-block;margin-bottom:0;\">Assessor Details:</h4>
										...
										while ($arearow = mysql_fetch_array($qryareasresults))
										{
											...
											$isSelected = ($areaid==$claimdetailsrow['assessor_area_id'] || $areaid==$area) ? 'selected="selected"' : '';
							...
							<table bgcolor=\"#9797FF\" style=\"border:1px solid #000000;\" width=\"100%\" class='blue-bg'>
								...
								if ( isset($_POST['area']) && !empty($_POST['area']) ) {
									...
									foreach($partsuppliers as $supplier) {
										...
										$ps_string = ucwords(trim($supplier["contactname"])) . ', ' . ucwords(trim($supplier["name"])) . ', Tel:' . $supplier["telno"] . ', Fax:' . $supplier["faxno"] . ', Cel:' . $supplier["cellno"] . ', Email:' . $supplier["email"];
										...
										echo '<div style="display: inline;"><a href="mailto:'.$supplier["email"].','.$supplier["email2"].'?subject='.$emailSubject.'" type="PartSuppliers" claimId="$claimid" class="send-email" alt="Send Email" title="Send Email" ><img src="../images/email-send.png" style="height:20px;vertical-align:middle;" /></a></div>';
									...
									echo '<tr><td style="padding:10px;">
										...
										<div style="display: inline;"><a href="mailto:'.$allemailslist.'?subject='.$emailSubject.'" type="PartSuppliers" claimId="$claimid" class="send-email" alt="Send Email" title="Send Email" ><img src="../images/email-send.png" style="height:20px;vertical-align:middle;" /></a></div>
    ...
    if ($step == 2) //parts
    {
        ...
        if ($count == 0)
        {
            ...
            echo "<br><form action=\"loggedinaction.php?action=newitem\" method=\"POST\" name=\"addnewitemform\">
						...
						<p>Client Number: <strong>$clientnumber2</strong>; Client Name: <strong>$clientname</strong>; Claim Number: <strong>$claimnumber</strong>; Vehicle Registration Number: <strong>$vehicleregistrationno</strong></p>
...
<SCRIPT LANGUAGE=\"JavaScript\" ID=\"js1\">
...

	{
        ...
        echo "	<p>Client Number: <strong>$clientnumber2</strong>; Client Name: <strong>$clientname</strong>; Claim Number: <strong>$claimnumber</strong>; Vehicle Registration Number: <strong>$vehicleregistrationno</strong></p>
    ...
    if ($step == 4) //Reports
    {
        echo "<form method=\"POST\" action=\"loggedinaction.php?action=editclaim\" name=\"topform\" class='no-show-in-print'>
					...
					<input type=\"button\" value=\"Parts\" onClick=\"document.theform.next.value = 1; document.topform.stepto.value = 2;
        ...
        echo "	<p>Client Number: <strong>$clientnumber2</strong>; Client Name: <strong>$clientname</strong>; Claim Number: <strong>$claimnumber</strong>; Vehicle Registration Number: <strong>$vehicleregistrationno</strong></p> 
				<p>Select which report you want to view:<br><br>
								...
								<a href=\"reports.php?action=pbfax&amp;claimid=$claimid\" target=\"_blank\" class=\"newWindow\">Panel Beater Fax</a> || <a href=\"reports.php?action=pbdocrequest&amp;claimid=$claimid\" target=\"_blank\" class=\"newWindow\">Panel Beater Document Request</a>
    ...
    if ($step == 5)
    {
        ...
        echo "<form method=\"POST\" action=\"loggedinaction.php?action=editclaim\" class='no-show-in-print'>
					...
					<input type=\"button\" value=\"Parts\" onClick=\"document.theform.next.value = 1; document.datesform.stepto.value = 2;
    ...
    if ($step == 6)
    {
		echo "<form method=\"POST\" action=\"loggedinaction.php?action=editclaim\" name=\"topform\" class='no-show-in-print'>
						...
						<input type=\"hidden\" name=\"stepto\" value=\"2\" /> <input type=\"hidden\" name=\"claimid\" value=\"$claimid\">									<input type=\"hidden\" name=\"fromstep\" value=\"2\" /> 		 
																		 ...
																		 </form><p>Client Number: <strong>$clientnumber2</strong>; Client Name: <strong>$clientname</strong>; Claim Number: <strong>$claimnumber</strong>; Vehicle Registration Number: <strong>$vehicleregistrationno</strong></p>";
					...
					<td>	
						...
						<table bgcolor=\"#D3D3FF\" style=\"border:1px solid #000000;\" width=\"100%\" class=\"pad-table blue-bg\">
								...
								<tr>
									...
									<td colspan=\"6\"><h4 style=\"margin-top:0px;margin-bottom:0;display:inline-block;\">Panel Beater:</h4>
								...
								<tr>
									<td>Workshop Manager:</td>
									<td><input type=\"text\" value=\"$pbworkshopmanager\" maxlength=\"50\" name=\"workshopmanager\"  /></td>
...
function AddNewClaim($clientname, $clientno, $claimno, $clientcontactno1, $clientcontactno2, $clientemail,
    ...
    $quoteamount, $assessorid, $pbname, $pbowner, $pbcostingclerk, $pbcontactperson, $workshopmanager, 
	$pbcontactnumber, $pbcontactnumber2, $pbfaxno, $pbemail, $pbadr1, $pbadr2, $pbadr3, $pbadr4, $notes, $vehiclevin='')
{
    ...
    if ($panelbeaterid == 0)
    {
        ...
        $qryinsert = "insert into panelbeaters (`id`, `name`, `owner`, `costingclerk`, `contactperson`, `workshopmanager`, `adr1`, `adr2`, `adr3`, `adr4`, 
									 	    ...
									 	    values ('', '$pbname', '$pbowner', '$pbcostingclerk', '$pbcontactperson', '$workshopmanager', '$pbadr1', '$pbadr2',
    ...
    $qryinsert = "insert into claim (`id`, `clientname`, `clientno`, `claimno`, `clientcontactno`, `clientcontactno2`, `clientemail`, `panelbeaterid`, `makemodel`,



		                                 `vehicleregistrationno`, `vehicleyear`, `vehicletype`, `vehiclevin`, `administratorid`, `quoteno`, `insurerid`, `claimsclerkid`,



										 `authamount`, `excess`, `betterment`, `quoteamount`, `assessorid`, `assessor_area_id`)
...
function SaveStep($claimid, $step, $ccloggedin, $ccid)
{
    ...
    if ($step == 1)
    {
		...
		$estimator = addslashes($_REQUEST["estimator"]);
        ...
        $qryupdatepb = "update panelbeaters set `name` = '$pbname',
													  ...
													  `estimator`= '$estimator',
													  `pbestimatoremail`= '$pbestimatoremail',
													  `latitude`= '$latitude',
													  `longitude`= '$longitude',
...
function ClaimEdited($claimid, $clientname, $clientno, $claimno, $clientcontactno1,
    ...
    $excess, $betterment, $quoteamount, $assessorid, $pbname, $pbowner, $pbcostingclerk,
    $pbcontactperson, $workshopmanager, $pbcontactnumber, $pbcontactnumber2, $pbfaxno, $pbemail, $pbadr1, $pbadr2, $pbadr3,
    $pbadr4, $notes)
{
...
function asEditClaim($id, $step, $assid)
{
    ...
    if ($step == 1)
    {
						...
						<td>	
							...
							<table bgcolor=\"#D3D3FF\" style=\"border:1px solid #000000;\" width=\"100%\" class='blue-bg'>
								...
								<tr>
									...
									<td colspan=\"6\"><h4 style=\"margin-top:0px;margin-bottom:0;\">Panel Beater Details:</h4></td>
		...
		$workshopmanager = stripslashes($selectedpbrow["workshopmanager"]);
...
function ccSearchClaims($claimno, $clientno, $clientname, $from, $admin, $ccid)
{
    ...
    else
    {
        ...
        echo "Search results for Client Number: <strong>$clientno</strong>, Client Name: <strong>$clientname</strong> and Claim Number: <strong>$claimno</strong><br><br>	<form action=\"ccloggedinaction.php?action=ccsearchclaims\" method=\"post\" name=\"searchform\">
    ...
    $pbcontactnumber, $pbcontactnumber2, $pbfaxno, $pbemail, $pbadr1, $pbadr2, $pbadr3, $pbadr4, $notes)
{
    ...
    if ($panelbeaterid == 0)
    {
        ...
        $qryinsert = "insert into panelbeaters (`id`, `name`, `owner`, `costingclerk`, `contactperson`, `adr1`, `adr2`, `adr3`, `adr4`, 
    ...
    $qryinsert = "insert into claim (`id`, `clientname`, `clientno`, `claimno`, `clientcontactno`, `clientcontactno2`, `clientemail`, `panelbeaterid`, `makemodel`,
										 ...
										 `authamount`, `excess`, `betterment`, `quoteamount`, `assessorid`)
