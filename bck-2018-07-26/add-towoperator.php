...
if ( !empty($_POST) ) {
	...
	$qryinsert = "	INSERT INTO towingoperators 
					( `name`, `contactname`, `telno`, `faxno`, `cellno`, `email`, `adr1`, `adr2`, `adr3`, `adr4`, `bankdetails`, `vatno`, `email2`, `latitude`, `longitude`, `cars`, `hcv`, `roll_back`, `vehicle_registration_no`, `password`)
					VALUES 
					('$name', '$contactname', '$telno', '$faxno', '$cellno', '$email', '$adr1', '$adr2', '$adr3', '$adr4', '$bankdetails', '$vatno', '$email2', '$latitude', '$longitude', '$cars', '$hcv', '$roll_back', '$vehicle_registration_no', MD5('$password') ) ";
