...
if ( !empty($_POST) ) {
	...
	$qryinsert = " INSERT INTO panelbeaters ( `name`, `owner`, `costingclerk`, `contactperson`, `adr1`, `adr2`, `adr3`, `adr4`, `contactno`, `faxno`, `email`, `latitude`, `longitude`, `owneremail`, `costingclerkemail`, `workshopmanager`, `workshopmanageremail`, `estimator`, `pbestimatoremail`, `password`)
	VALUES ( '$name', '$owner', '$costingclerk', '$contactperson', '$adr1', '$adr2', '$adr3', '$adr4', '$contactno', '$faxno', '$email', '$latitude', '$longitude', '$owneremail', '$costingclerkemail', '$workshopmanager', '$workshopmanageremail', '$estimator', '$pbestimatoremail', MD5('$password') )";
...
<form method="post" action="add-panelbeater.php" name="theform" enctype="multipart/form-data">
	...
	<table class="table table-striped" cellspacing="10">
		...
		<tr>
			<td>Email Address:</td>
			<td><input type="text" name="pbemail" maxlength="50"></td>
		</tr>
