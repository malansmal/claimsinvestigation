<?php
...

	{
		...
		$qryinsert = "insert into partssuppliers (`id`, `name`, `contactname`, `telno`, `faxno`, `cellno`, `email`, `adr1`, `adr2`, `adr3`, `adr4`,  `comments`, `password`, `bankdetails`, `vatno`, `email2`, `latitude`, `longitude`, `used`, `alternate`, `new`)
...
<br><input type=\"submit\" value=\"Save\"> <input type=\"reset\" value=\"Clear\"> <input type=\"hidden\" name=\"partsupplierid\" value=\"$partssupplierid\">
...

	{
		...
		$used = addslashes($_REQUEST["used"]);

		$alternate = addslashes($_REQUEST["alternate"]);
		...
		$qryupdate = "update partssuppliers set `name` = '$name',
										   ...
										   `vatno` = '$vatno' where `id` = $partsupplierid";
...

	{
		...
		$qryinsert = "insert into `key` (`id`, `key`, `action`) values ('', '$key', 'deletepartsupplier')";
